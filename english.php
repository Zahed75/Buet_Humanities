	...
	<section id="accounting">
		...
		<div class="container">
			<table class="table table-bordered table-dark">
				<thead>
					<tr id="heading">
						<th colspan="4" scope="col">Subject: English</th>
					</tr>
				</thead>
				<tbody>
					<tr id="heading1">
						<th scope="row">Course No.</th>
						<td>Course Name(Theory)</td>
						<td>Credit</td>
						<td>Department</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-101 </a></th>
						<td>English</td>
						<td>3.00 Credit</td>
						<td>ME, MME</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-111 </a></th>
						<td>English</td>
						<td>2.00 Credit</td>
						<td>WRE, NAME</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-125 </a></th>
						<td>English</td>
						<td>2.00 Credit</td>
						<td>URP,CHE</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-135</a></th>
						<td>English</td>
						<td>3.00 Credit</td>
						<td>EEE</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-183 </a></th>
						<td>English</td>
						<td>3.00 Credit</td>
						<td>CSE</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-185 </a></th>
						<td>English</td>
						<td>2.00 Credit</td>
						<td>CE</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-187 </a></th>
						<td>English</td>
						<td>3.00 Credit</td>
						<td>BME</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-207 </a></th>
						<td>Advanced English</td>
						<td>2.00 Credit</td>
						<td>MME,WRE</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-705 </a></th>
						<td>English</td>
						<td>2.00 Credit</td>
						<td>ARCH</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-711 </a></th>
					...
					<tr id="heading1">
						<th scope="row">Course No.</th>
						<td>Course Name(Sessional)</td>
						<td>Credit</td>
						<td>Department</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-102 </a></th>
						<td>English Language Practice</td>
						<td>1.5 Credit</td>
						<td> IPE,NAME </td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-104 </a></th>
						<td> English Skills Sessional</td>
						<td>1.5 Credit</td>
						<td>BME</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-138 </a></th>
						<td>English Language Practice </td>
						<td>1.5 Credit</td>
						<td></td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-272</a></th>
						<td>Developing English Skills</td>
						<td>1.5 Credit</td>
						<td>URP,CHE,EEE</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-172</a></th>
						<td>Developing English Skills</td>
						<td>1.5 Credit</td>
						<td>CSE</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-274 </a></th>
						<td>Developing English Skills</td>
						<td>1.5 Credit</td>
						<td> CE, WRE</td>
					</tr>
						...
						<div class="footnav">
							<nav>
								<ul>
									...
									<li><a href="https://webmail.buet.ac.bd/">Web mail</a></li>
