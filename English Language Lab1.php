...
<body>
	...
	<div class="headerpart">
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<div class="logo">
						<a href="index.php" target="self"><img src="assets/images/Logo2.png" alt="logo"></a>
					</div>
				</div>
				<div class="col-md-4">
					<div class="var">
				...
				<div class="col-md-4">
					<div class="lefnav">
						<ul>
							...
							<a href="https://biis.buet.ac.bd">
								<li>BIIS |</li>
							</a>
							<a href="https://webmail.buet.ac.bd">
								<li>Web mail|</li>
							</a>
							<a href="https://lib.buet.ac.bd/home/">
	...
	<section id="lab_txt">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h2>ENGLISH LANGUAGE LABORATORY</h2>
					<p>The Humanities Department has set up two technically equipped English Language Laboratories with
						a view to improving the speaking and listening skills of the students side by side with
						developing their reading and writing capabilities. With the establishment of English Language
						Laboratories English teaching at BUET has become practice-oriented. Students’ theoretical
						knowledge of English is being supplemented by a variety of practical activities in the labs.
						Thus English teaching at BUET has proved to be an effective combination of theory and practice.
						In the Language laboratories students are taught in the audio-visual method with the use of
						technical equipment. At present students from almost all the Departments of BUET attend the
						sessional classes in the Language Laboratories where they make oral interaction in English and
						listen to the audio cassettes and view the videos on effective presentation, report-writing and
						other forms of technical writings. A great deal of practice on writing skills is also done in
						the sessional classes.</p>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-6 col-sm-6 copyright">
							...
							Design &amp; Developed by <a style="text-decoration: none; color: white;"
								target="_blank">Zahed
								Hasan</a>
