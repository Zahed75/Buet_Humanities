		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4">
					<div class="lefnav">
						<ul>
							<a href=""><li>BUET Home |</li></a>
							<a href=""><li>BIIS |</li></a>
							<a href=""><li>Web mail|</li></a>
							<a href=""><li>Centeral library</li></a>
						</ul>
					</div>
					<div class="srch">
	...
	<section id="accounting">
			...
			<div class="container">
				<table class="table table-bordered table-dark">
					<thead>
					  <tr id="heading">
						<th colspan="4" scope="col">Subject: Psychology</th>
					  </tr>
					</thead>
					<tbody>
					  <tr id="heading1">
					  ...
					  <tr>
						<th scope="row"><a href="#"> Hum-109 </a></th>
						<td>Social Psychology</td>
						<td>3.00 Credit</td>
						<td>CHE</td>
					  </tr>
					  <tr>
						<th scope="row"><a href="#"> Hum-119 </a></th>
						<td>Psychology</td>
						<td>2.00 Credit</td>
						<td>ARCH</td>
					  </tr>
					  <tr>
						<th scope="row"><a href="#"> Hum-243</a></th>
						<td> Psychology</td>
						<td>3.00 Credit</td>
						<td>BME</td>
					  </tr>
                      <tr>
						<th scope="row"><a href="#"> Hum-271 </a></th>
						<td>Social Psychology</td>
						<td>2.00 Credit</td>
						<td>URP</td>
                      </tr>
                      <tr>
						<th scope="row"><a href="#"> Hum-325 </a></th>
						<td>Psychology</td>
						<td>2.00 Credit</td>
						<td>MME</td>
                      </tr>
                      <tr>
						<th scope="row"><a href="#"> Hum-709 </a></th>
						<td>Human Psychology and Environment</td>
						<td>2.00 Credit</td>
						<td>ARCH</td>
					  </tr>
					</tbody>
