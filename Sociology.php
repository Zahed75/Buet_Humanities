	...
	<section id="accounting">
		...
		<div class="container">
			<table class="table table-bordered table-dark">
				<thead>
					<tr id="heading">
						<th colspan="4" scope="col">Subject: Sociology</th>
					</tr>
				</thead>
				<tbody>
					<tr id="heading1">
					...
					<tr>
						<th scope="row"><a href="#"> Hum-127 </a></th>
						<td>Sociology</td>
						<td>3.00 Credit</td>
						<td>EEE</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-147 </a></th>
						<td>Introduction to sociology</td>
						<td>2.00 Credit</td>
						<td>ARCH</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-179</a></th>
						<td>Sociology</td>
						<td>3.00 Credit</td>
						<td>URP</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-201 </a></th>
						<td>Sociology</td>
						<td>3.00 Credit</td>
						<td>ME, CHE</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-211 </a></th>
						<td>Sociology</td>
						<td>2.00 Credit</td>
						<td>IPE, NAME, WRE, CSE, MME</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-245 </a></th>
						<td>Sociology</td>
						<td>3.00 Credit</td>
						<td>BME</td>
					</tr>
					<tr>
					<th scope="row"><a href="#"> Hum-355 </a></th>
					<td>Sociology</td>
					<td>2.00 Credit</td>
					<td>CE</td>
					</tr </tbody> </table> </div> 
				<div class="soc_foot">
				</section> <div id="footer" style="background-color: #ac1f25">
					<div class="container">
						<div class="row">
