...
if(isset($_POST['submit'])){
	...
	$insert_query="INSERT INTO office_staff(info,occupation,image)
	values('$info','$occupation','$img_name')";
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div class="box-header">
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Add Office Staff
						...
						<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
						  <fieldset>
							<div class="control-group">
							  ...
							  <div class="controls">
								<textarea class="cleditor" id="textarea2" name="info" rows="4"></textarea>
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="typeahead">Occupation</label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="occupation">								
							  </div>
							</div>
