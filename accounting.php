			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4">
					  ...
					  <div class="dp">
						<a href="index.php"><h3><b>Department of Humanities</b></h3></a>
					  </div>
					...
					<div class="col-md-4">
						<div class="lefnav">
							<ul>
								<a href="https://www.buet.ac.bd/web/"><li>BUET Home |</li></a>
								<a href="https://biis.buet.ac.bd"><li>BIIS |</li></a>
								<a href="https://webmail.buet.ac.bd"><li>Web mail|</li></a>
								<a href="https://lib.buet.ac.bd/home/"><li>Centeral library</li></a>
							</ul>
						</div>
						<div class="srch">
		...
		<div class="navpart">
			...
			<div class="container">
				<table class="table table-bordered table-dark">
					<thead>
					  <tr id="heading">
						<th colspan="4" scope="col">Subject: Accounting</th>
					  </tr>
					</thead>
					<tbody>
					  <tr id="heading1">
					  ...
					  <tr>
						<th scope="row"><a href="#"> Hum-225 </a></th>
						<td>Accounting</td>
						<td>2.00 Credit</td>
						<td>URP</td>
					  </tr>
					  <tr>
						<th scope="row"><a href="#"> Hum-279 </a></th>
						<td>Financial and Managerial Accounting</td>
						<td>3.00 Credit</td>
						<td>EEE</td>
					  </tr>
					  <tr>
						<th scope="row"><a href="#"> Hum-303 </a></th>
						<td>Principles of Accounting</td>
						<td>3.00 Credit</td>
						<td>ME, CHE, MME</td>
					  </tr>
					  <tr>
						<th scope="row"><a href="#"> Hum-313 </a></th>
						<td>Principles of Accounting</td>
						<td>2.00 Credit</td>
						<td>ARCH, WRE,  NAME</td>
					  </tr>
					  <tr>
						<th scope="row"><a href="#"> Hum-353 </a></th>
						<td>Accounting</td>
						<td>2.00 Credit</td>
						<td>CE</td>
					  </tr>
					  <tr>
						<th scope="row"><a href="#"> Hum-371 </a></th>
						<td>Financial and Managerial Accounting</td>
						<td>2.00 Credit</td>
						<td>CSE</td>
					  </tr>
					  <tr>
						<th scope="row"><a href="#"> Hum-905 </a></th>
						<td>Cost and Financial Accounting</td>
						<td>2.00 Credit</td>
						<td>ARCH</td>
					  </tr>
					</tbody>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 col-sm-6 copyright">
						...
						Design &amp; Developed by <a style="text-decoration: none; color: white;" target="_blank">Zahed Hasan</a>
