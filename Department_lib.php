...
<body>
	...
	<div class="dptmnt_lib">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h2>DEPARTMENTAL LIBRARY</h2>
					<p>The Department has a library located at the third floor of the URP Building. The Library has a
						collection of books on different Humanities,
						Social Science and Commerce subjects. Currently it has more than 700 books and a large number of
						journals. The Department
						is collecting books from different sources, enriching the library continually. The resources
						available in the library provide the teachers with materials
						for developing their teaching and also help them in pursuing research activities.</p>
				</div>
			</div>
		</div>
	</div>
