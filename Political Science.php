	...
	<section id="accounting">
		...
		<div class="container">
			<table class="table table-bordered table-dark">
				<thead>
					<tr id="heading">
						<th colspan="4" scope="col">Subject: Political Science</th>
					</tr>
				</thead>
				<tbody>
					<tr id="heading1">
					...
					<tr>
						<th scope="row"><a href="#"> Hum-203 </a></th>
						<td>Government</td>
						<td>3.00 Credit</td>
						<td>ME, CHE</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-213 </a></th>
						<td>Government</td>
						<td>2.00 Credit</td>
						<td> CSE, WRE</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-281</a></th>
						<td> Political Science and Local Government</td>
						<td>3.00 Credit</td>
						<td>URP</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-375 </a></th>
						<td>Government</td>
						<td>2.00 Credit</td>
						<td>CE</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-475 </a></th>
						<td>Government</td>
						<td>2.00 Credit</td>
						<td>CSE</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-419 </a></th>
						<td>Government</td>
						<td>3.00 Credit</td>
						<td>MME</td>
					</tr>
