	...
	<section id="accounting">
		...
		<div class="container">
			<table class="table table-bordered table-dark">
				<thead>
					<tr id="heading">
						<th colspan="4" scope="col">Subject: Logic and Philosophy</th>
					</tr>
				</thead>
				<tbody>
					<tr id="heading1">
					...
					<tr>
						<th scope="row"><a href="#"> Hum-231 </a></th>
						<td>Philosophy</td>
						<td>2.00 Credit</td>
						<td>ARCH</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-315 </a></th>
						<td>Logic and Philosophy</td>
						<td>2.00 Credit</td>
						<td>ARCH</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-137 </a></th>
						<td>Professional Ethicst</td>
						<td>3.00 Credit</td>
						<td>EEE</td>
					</tr>
					<tr>
						<th scope="row"><a href="#"> Hum-415 </a></th>
